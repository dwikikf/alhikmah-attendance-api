...
func TestProcessQRScan_UnauthorizedTeacher(t *testing.T) {
	...
	assert.Error(t, err)
	assert.EqualError(t, err, "teacher does not have access to this student's class")
}
...
func TestProcessQRScan_AlreadyScannedToday(t *testing.T) {
	...
	assert.Error(t, err)
	assert.EqualError(t, err, "student has already attended today")
}
...
func TestProcessManualAttendance_InvalidStatus(t *testing.T) {
	...
	assert.Error(t, err)
	assert.EqualError(t, err, "invalid attendance status")
}
...
func TestUpdateManual_NotFound(t *testing.T) {
	...
	assert.Error(t, err)
	assert.EqualError(t, err, "attendance data not found")
}
