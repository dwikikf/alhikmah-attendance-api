...
func (h *ReportHandler) exportDaily(c *gin.Context, report *dto.DailyReportResponse, format string) {
...
func (h *ReportHandler) exportMonthly(c *gin.Context, report *dto.MonthlyReportResponse, monthStr string, format string) {
...
func (h *ReportHandler) exportSemester(c *gin.Context, report *dto.SemesterReportResponse, format string) {
